...
public class ImageTest {
	...
	public static void reSizeTFile(File smallImg, int resizeHeight, int resizeWidth) throws IOException {
	...
	public static void resizePic(File smallImg, File bigImg, int leftX, int leftY, int resizeHeight, int resizeWidth) throws IOException {
		FileInputStream smallStream = new FileInputStream(smallImg);
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
		byte[] buffer = new byte[1024];
		int len;
	...
	public static void resizePicNoScale(File smallImg, File bigImg, int leftX, int leftY, int resizeHeight, int resizeWidth) throws IOException {
		FileInputStream smallStream = new FileInputStream(smallImg);
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
		byte[] buffer = new byte[1024];
		int len;
